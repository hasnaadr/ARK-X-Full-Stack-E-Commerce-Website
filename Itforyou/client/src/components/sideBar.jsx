...
export default function Sidebar() {
  ...
  return (
    <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5">
      ...
      <nav className="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-gray-700">
        ...
        >
          ...
          <Link to="/costumerData">Profile</Link>
        </div>
        <div
          role="button"
          tabIndex={0}
